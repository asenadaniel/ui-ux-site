  ...
  return (
    <div className='flex flex-col w-full py-[48px] lg:py-[60px] lg:flex-row lg:gap-x-6'>
      ...
      <div className=' lg:w-1/3 lg:py-[32px] pr-[56px]'>
        ...
        <h1 className='py-4 text-[#172026] font-medium text-[24px] lg:text-[42px] lg:leading-[58px]'>Let’s clarify some of your questions</h1>
        <p className=' text-[#36485C] text-[16px] pb-[24px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore </p>
      </div>
              ...
              <Accordion.Item value={`item-${index + 1}`} className=' bg-[#E3F1FF] p-[16px] rounded-[8px]'>
                <Accordion.Header>
                  <Accordion.Trigger className=' flex w-full items-center justify-between'>
                    <p className=' text-left font-medium text-[#172026] text-[18px] lg:h-6'>{item.question}
                    </p>
                    <span><Image src={plus} alt='plus' className=' w-10 h-10' /></span>
                  </Accordion.Trigger>
                </Accordion.Header>
                <Accordion.Content>
                  <p className=' text-[#36485C] pt-[8px]'>{item.answer}</p>
                </Accordion.Content>
              </Accordion.Item>
            </div>
          ))}
